            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        添加轮播图(<span class="text-color">图片规格 375 * 150</span>)
                    </header>

                    <section class="panel">
                        <div class="panel-body">
                            <form class="form-horizontal tasi-form" method="post" enctype="multipart/form-data"
                                  action="{{ route('admin.demo.banner.create.action') }}">
                                ...
                                <div class="form-group has-warning">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="ex_id">
                                    </div>
                                </div>
                                ...
                                <div class="form-group has-warning">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <img class="img-check" src="{{ asset('/static/img/default-banner.jpg') }}">
