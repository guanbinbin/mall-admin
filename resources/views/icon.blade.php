        ...
        <section class="wrapper">
            ...
            <div class="row-fluid fontawesome-icon-list">
                ...
                <div class="row the-icons">
                    ...
                    <div class="col-sm-3"><i class="icon-dollar"></i> icon-dollar <span class="muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-sm-3"><i class="icon-renminbi"></i> icon-renminbi <span class="muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-sm-3"><i class="icon-bitcoin"></i> icon-bitcoin <span class="muted">(alias)</span>
                    </div>
            ...
            <section id="web-application">
                ...
                <div class="row the-icons">
                    ...
                    <div class="col-sm-3"><i class="icon-mail-forward"></i> icon-mail-forward <span class="muted">(alias)</span>
                    </div>

                    <div class="col-sm-3"><i class="icon-mail-reply"></i> icon-mail-reply <span
                                class="muted">(alias)</span></div>
                    ...
                    <div class="col-sm-3"><i class="icon-power-off"></i> icon-power-off <span
                                class="muted">(alias)</span></div>
                    ...
                    <div class="col-sm-3"><i class="icon-star-half-full"></i> icon-star-half-full <span class="muted">(alias)</span>
                    </div>
                    ...
                    <div class="col-sm-3"><i class="icon-unchecked"></i> icon-unchecked <span
                                class="muted">(alias)</span></div>
            ...
            <section id="text-editor">
                ...
                <div class="row the-icons">
                    ...
                    <div class="col-sm-3"><i class="icon-paperclip"></i> icon-paperclip <span
                                class="muted">(alias)</span></div>
                    ...
                    <div class="col-sm-3"><i class="icon-rotate-left"></i> icon-rotate-left <span
                                class="muted">(alias)</span></div>

                    <div class="col-sm-3"><i class="icon-rotate-right"></i> icon-rotate-right <span class="muted">(alias)</span>
                    </div>
